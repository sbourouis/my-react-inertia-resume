import { Project, PROJECT_TYPE, RESOURCE_TYPE } from '@/types/project';
  ...
  database or on the filesystem. Firstly, I entirely developed this application using JQuery and then I
   started from scratch using AngularJS.
    ...
    },
    {
        ...
        type: PROJECT_TYPE.PRO,
        description:
            'Full-stack development (Angular, Node.js) of a web application to annotate surgical videos',
        details: `
...
architecture.
ASCII representation, ranking, random game element generation (enemies, map, objects, ...), permadeath, ...
        `,
        keywords: ['Java', 'Swing'],
        resources: [
            {
